                        ...
                        @foreach($user as $author)
                            <li class="avatar-item">
                                <a href="#" class="avatar large img-holder" style="--width: 100; --height: 100;">
                                    <img src="{{ asset('storage/' . $author->image) }}" width="100" height="100" alt="top author" class="img-cover">
                                </a>
                            </li>
                        @endforeach
                    </ul>
                    ...
                    <li>
                        <div class="blog-card">
                            ...
                            <figure class="card-banner img-holder" style="--width: 550; --height: 660;">
                                <img src="{{ asset('storage/' . $blog->image) }}" width="550" height="660" loading="lazy" alt="Blog Image" class="img-cover">

                                <ul class="avatar-list absolute">
                                    @foreach($blog->user as $user)
                                        <li class="avatar-item">
                                            <a href="#" class="avatar img-holder" style="--width: 100; --height: 100;">
                                                <img src="{{ asset('storage/' . $user->image) }}" width="100" height="100" loading="lazy" alt="Author" class="img-cover">
                                            </a>
                                        </li>
                                    @endforeach
                                </ul>
